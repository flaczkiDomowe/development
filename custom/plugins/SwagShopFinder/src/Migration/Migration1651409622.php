...
class Migration1651409622 extends MigrationStep
{
    ...
    {
        $connection->executeStatement("CREATE TABLE IF NOT EXISTS `swag_shop_finder` ( `id` BINARY(16) NOT NULL,
    ...
    `updated_at` DATETIME(3),PRIMARY KEY (`id`),
